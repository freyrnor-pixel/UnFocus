...
const is: typeof en = {
  ...
  cardTypes: {
    ...
    noSteps: 'Bættu skrefi við þetta kort til að taka það eitt í einu.',
  },
  ...
  dayLog: {
    ...
    calendars: {
      ...
      hint: 'Viðburðir héðan sjást framan við núlínuna. Ekkert er skrifað til baka.',
    },
  },
  sendTo: {
    title: 'Senda það í…',
  ...
  timeLabel: 'Tími',
  wheneverHint: 'Enginn fastur tími – birtist sem eitthvað til að gera þann dag.',
  ...
  scanHintBanner: 'Beindu myndavélinni að kvittuninni. Textinn þarf að vera skýr og vel lýstur.',
  store: 'Verslun',
  ...
  selectStoreFirstBody: 'Veldu úr hvaða verslun kvittunin er áður en þú bætir vörum við.',
  takePhoto: 'Taka mynd',
  ...
  manualEntryHint: 'Skrifaðu vöruheiti, eitt í hverja línu. Þau fara á innkaupalistann þinn.',
  ...
  version: {
    ...
    failed: 'Náði ekki að leita að uppfærslum. Athugaðu tenginguna og reyndu aftur.',
    disabled: 'Þráðlausar uppfærslur eru slökktar í þessari útgáfu (þetta er debug-útgáfa). Settu upp release-útgáfu til að fá OTA-uppfærslur.',
    updateAvailable: 'Uppfærsla tilbúin — ýttu til að setja upp og endurræsa',
    experimental: 'Tilraunaútgáfa — UnFocus er í vinnslu, svo hlutir geta breyst, færst til eða bilað.',
  },
  ...
  firstRun: {
    ...
    reRunHint: 'Farðu aftur yfir hreyfingu, leturstærð, útlit og upphafsskjá. Það byrjar á því sem þú ert með núna.',
    motion: {
      title: 'Hversu mikla hreyfingu viltu?',
      sub: 'Hreyfimyndir geta tengt hlutina saman, eða þvælst fyrir.',
      osReduced: 'Síminn þinn biður um minni hreyfingu, svo appið heldur henni þegar niðri.',
    ...
    textSize: {
      ...
      sub: 'Þessi skjár breytist meðan þú ýtir, svo þú sérð stærðina sem þú velur.',
  ...
  tour: {
    ...
    steps: {
      home: {
        ...
        body: 'Það sem er á dagskrá í dag safnast hér — verkefni, innkaup, venjur. Haltu á korti til að færa það, svo það sem þú horfir mest á sé efst.',
      },
      plans: {
        title: 'Verkefni halda utan um það sem dagurinn þarf',
        body: 'Skráðu eitt sem þú vilt koma í verk. Lítið er gott — verkefni sem þú klárar slær því sem þú skrifar aftur og aftur.',
      },
      shopping: {
        title: 'Innkaupalistinn núllstillir sig sjálfur',
        body: 'Vikulisti fyrir matvöru og mánaðarlisti fyrir það sem heimilið þarf. Hakaðu við á meðan þú gengur um; vikulistinn byrjar upp á nýtt á þeim degi sem þú velur.',
      },
      habits: {
        title: 'Venjur, einn dag í einu',
        body: 'Veldu eina til að byrja á. Hér er engin röð til að missa — rólegur dagur er bara rólegur dagur.',
      },
      health: {
        title: 'Heilsa tekur eftir mynstrum',
        body: 'Skráðu einkenni eða hvernig þú svafst, og þróunin byggist upp yfir tíma. Lyfin eru hér líka, í morgun-, hádegis-, kvöld- og næturhólfum.',
      },
    },
    finale: {
      title: 'Þetta var kynningin',
      body: 'Allt annað er aðgengilegt úr þessum fimm flipum, og hver skjár er með ⓘ-hnapp með ábendingum og stillingum fyrir þann skjá.',
      experimental: 'UnFocus er í vinnslu. Hlutir geta breyst, færst til eða komið hálfkláraðir — það er við því að búast. Allt situr eftir í símanum þínum, og öll viðbrögð móta það sem kemur næst.',
      done: 'Byrja að nota appið',
    },
  },
  basics: {
    title: 'Nokkur grunnatriði',
    sub: 'Þessi skjár breytist meðan þú ýtir, svo þú sérð hvað þú ert að velja. Allt er þegar með stillingu sem virkar.',
    /* Sjá enska tvíburann: þetta er það fyrsta sem glænýr notandi sér. */
    welcomeTitle: 'Dagurinn þinn, á einum stað',
    welcomeSub: 'UnFocus heldur verkefnum, innkaupum, venjum og heilsu saman, svo það sé einn staður til að líta á. Ekkert hér heldur stigatölu.',
    appearance: 'Útlit',
    textSize: 'Leturstærð',
    motion: 'Hreyfing',
    language: {
  ...
  doneShoppingReceiptBody: 'Skannaðu eða settu inn mynd til að skrá kaupin, eða slepptu því og kláraðu.',
  ...
  deleteListConfirmBody: 'Þetta eyðir listanum og öllum vörum á honum varanlega.',
  ...
  monthlyResetReviewIntro: 'Farðu yfir listana og birgðirnar, eða slepptu því og notaðu sjálfgefnu valkostina.',
  ...
  monthlyResetReviewInventoryHint: 'Stilltu magnið fyrir vörur sem þú átt enn til.',
  ...
  resetMonthlyListConfirmBody: 'Þetta fjarlægir tímabundnar vörur og byrjar nýtt núllstillingartímabil fyrir þennan lista.',
  ...
  resetAllMonthlyListsConfirmBody: 'Þetta fjarlægir tímabundnar vörur á öllum mánaðarlistum og skráir nýtt núllstillingartímabil. Þetta gerist venjulega sjálfkrafa á núllstillingardeginum þínum.',
  foodTabLabel: 'Matur',
  ...
  invalidMonthlyDateMsg: 'Skrifaðu dag á milli 1 og 31 — fyrra gildi sett aftur.',
  habits: {
    ...
    restDayHint: 'Þú hvílir í dag — orkan fyrir þessa venju stendur kyrr, hvorki umbun né refsing.',
  ...
  goals: {
    ...
    deleteConfirmBody: 'Verkefni og venjur sem eru tengd verða aftengd. Þetta er ekki hægt að afturkalla.',
    strengthLabel: 'Kraftur markmiðs — vex þegar þú vinnur í því, dvínar rólega þegar þú gerir það ekki.',
  ...
  onboarding: {
    ...
    restore: {
      ...
      body: 'Ef þú vistaðir afrit í gamla símanum geturðu sótt öll gögnin núna. Annars byrjarðu upp á nýtt.',
  ...
  settings: {
    ...
    energy: {
      label: 'Orkukerfi',
      hint: 'Fylgstu með dags- og vikuáætlun fyrir orku — verkefni og venjur geta gefið orku eða tekið hana.',
      ...
      customHint: 'Stilltu hversu mikla orku þú átt hvern vikudag.',
    },
    accessibility: {
      title: 'Aðgengi',
      ...
      glassSurfacesHint: 'Frostað gler á kortum, hnöppum og bæta-við-hnappinum. Slökktu á þessu fyrir einfalda, gegnheila fleti',
      fontSize: 'Leturstærð',
      fontSizeSmall: 'Lítil',
      fontSizeDefault: 'Venjuleg',
      fontSizeLarge: 'Stór',
      leftHanded: 'Örvhent stilling',
      leftHandedHint: 'Færir valmyndarhnappinn yfir á vinstri hlið',
    ...
    quietHours: {
      ...
      hint: 'Áminningar um verkefni bíða þar til hljóðláti tíminn er liðinn í stað þess að trufla — þær glatast ekki. Áminningum um venjur á hljóðláta tímanum er sleppt í staðinn.',
    },
    // AP-06B — mánaðarleg innkaupaáætlun, borin saman við kvittanir í app/budget.tsx
    monthlyBudget: {
      label: 'Mánaðarleg fjárhagsáætlun',
      hint: 'Valfrjálst — sjáðu hvernig innkaupin standa í þessum mánuði á Fjárhagsskjánum.',
  ...
  config: {
    ...
    layouts: {
      ...
      inStore: {
        label: 'Í búðinni',
        hint: 'Stórar línur eftir deildum. Bara heiti, engin verð.',
      },
      timeline: {
        label: 'Á tímalínu',
        hint: 'Dagurinn eftir klukkunni. Rólegir kaflar dragast saman, svo það sem þú ert með á dagskrá kemur fram.',
      },
      nowNext: {
        label: 'Núna og næst',
        hint: 'Bara það sem þú ert í og það sem kemur næst. Hitt liggur falið.',
      },
      focusFirst: {
        label: 'Eitt í einu',
        hint: 'Eitt verkefni fremst, stuttur listi undir, og tala yfir restina.',
      },
      byPerson: {
        label: 'Eftir manneskju',
        hint: 'Skiptu Í dag í einn hluta á mann — með því hver á að gera hvað. Þessi vika og Öll verkefni halda sinni eigin röðun.',
      },
    },
    tabs: {
      general: 'Almennt',
    ...
    features: {
      ...
      sharing: {
        label: 'Deiling og QR',
        hint: 'Sendu verkefni og vörur til annarra, og taktu við þeirra.',
      },
      automations: {
        label: 'Sjálfvirkni',
        hint: 'Reglur sem keyra sjálfar, eins og að bæta vöru við þegar þú opnar listann.',
      },
      medicine: {
        label: 'Lyf',
        hint: 'Skammtakort á Heilsu-flipanum, með áminningu fyrir hvern hluta dagsins.',
      },
      dayLog: {
        label: 'Dagurinn eins og hann gerðist',
        /* Impersonal "þegar er búið" — the personal form would have to agree with gender. */
        hint: 'Heldur því sem þegar er búið fyrir ofan núlínuna, og því sem eftir er fyrir neðan.',
      },
      energy: {
        label: 'Orka',
        hint: 'Gefðu verkefnum og venjum orkugildi, og sjáðu hvað dagur eða vika leggur sig á.',
        modes: {
          label: 'Hvernig það er að klára',
          energy: {
            label: 'Orkuhamur',
            hint: 'Verkefni og venjur hafa orkukostnað, og mælirinn sýnir hvað dagurinn á eftir.',
          },
          rewards: {
            label: 'Umbunarhamur',
            hint: 'Enginn mælir og enginn kostnaður. Klárist eitthvað fyllist hakið, og meira er það ekki.',
          },
        },
      },
      growth: {
    ...
    autoBackup: {
      ...
      never: 'Ekkert afrit enn — það uppfærist þegar þú gerir breytingu.',
      backUpNow: 'Taka afrit núna',
      backedUpNow: 'Afritið er uppfært.',
      locationCanceled: 'Sjálfvirk afritun helst slökkt þar til þú velur hvar hún á að geymast.',
    ...
    desc: {
      ...
      shoppingDefault: 'Hvaða listi opnast fyrst þegar þú verslar.',
      weeklyResetDay: 'Vikudagurinn sem vikulistinn núllstillir sig.',
      monthlyResetDate: 'Ef mánuður er styttri núllstillist listinn á síðasta degi hans.',
      hints: 'Stuttar skýringar á hverjum skjá.',
      dataNote: 'Þetta núllstillir hluti. Það er ekki hægt að afturkalla.',
    },
  },
  backup: {
    title: 'Öryggisafrit',
    desc: 'Vistaðu öll gögnin þín í skrá sem þú heldur, eða endurheimtu úr einni. Ekkert er sent upp — skráin fer þangað sem þú velur.',
    ...
    tooNew: 'Þetta afrit var búið til í nýrri útgáfu af UnFocus. Uppfærðu appið fyrst og endurheimtu svo.',
    ...
    saveUnavailable: 'Vistun í tækinu er ekki í boði í þessu tæki.',
  },
  ...
  aiSetup: {
    ...
    invalidFile: 'Þetta lítur ekki út eins og útfyllt UnFocus-uppsetningarskrá. Gættu að því að senda inn skrána sem gervigreindin skilaði, ekki leiðbeiningarnar sjálfar.',
    staleWarning: 'Þessi skrá var búin til úr eldri útgáfu leiðbeininganna — eitthvað af nýrri valkostunum gæti vantað. Þú getur samt flutt inn það sem hún inniheldur, eða sótt nýjar leiðbeiningar fyrst.',
    previewTitle: 'Þetta verður sett upp',
    confirmImport: 'Setja það upp',
    nothingToImport: 'Ekkert til að flytja inn — í þessari skrá var ekkert sem appið þekkti.',
    importDone: (n: number) => `${n} ${isCount(n, 'breyting framkvæmd', 'breytingar framkvæmdar')}.`,
    deviceOnlyNote: 'Ekkert er sent neitt — skráin fer þangað sem þú velur, og innflutningur skrifar aðeins í þetta tæki.',
  ...
  habitRecurrenceWeeklyFlexibleHint: 'Hvaða dagur sem er telur — hún birtist daglega þar til þú hefur skráð hana nógu oft í vikunni.',
  ...
  habitReminderOffHint: 'Engin áminning — venjan birtist samt á sínum dögum.',
  ...
  tags: {
    ...
    settingsTitle: 'Merki',
    settingsHint:
      'Merki eru sameiginleg með öllum sem þú ert tengd(ur) við, svo merki þýðir það sama í báðum símum. Ef þú breytir heitinu fylgir það öllum verkefnunum.',
    empty: 'Engin merki enn. Bættu einu við frá verkefni.',
    removeTitle: (name: string) => `Fjarlægja „${name}“?`,
    removeBody: 'Verkefnin halda öllu öðru — þau missa aðeins þetta merki.',
    filterAll: 'Öll merki',
    more: (n: number) => `+${n}`,
  },
  energyBalance: {
  ...
  shareInstructions: 'Biddu hinn aðilann um að opna UnFocus, ýta á Skanna og svo á „Skanna QR-kóða“.',
  shareExplainShopping: 'Deildu QR-kóða sem hinn skannar inn í sinn eigin UnFocus-innkaupalista, eða sendu listann sem texta — móttakandinn þarf ekki UnFocus.',
  shareExplainTasks: 'Deildu QR-kóða sem hinn skannar inn í sinn eigin UnFocus, eða sendu listann sem texta — móttakandinn þarf ekki UnFocus.',
  shareExplainLaterBuild: 'Eins og er er þetta eitt afrit — samstilling milli síma í rauntíma kemur í síðari útgáfu.',
  scanQrCode: 'Skanna QR-kóða',
  qrScanMode: 'Skanna deildan lista',
  qrScanInstructions: 'Beindu myndavélinni að QR-kóða frá öðrum UnFocus-notanda.',
  ...
  noSharedItems: 'Ekkert deilt enn. Deildu lista eða skannaðu QR-kóða frá öðrum.',
  ...
  peers: {
    title: 'Pöruð tæki',
    settingsCardDesc: 'Haltu verkefnum og innkaupalista sjálfkrafa í takt við paraðan síma á sama Wi-Fi.',
    syncToggleLabel: 'Samstilla um Wi-Fi',
    syncUnavailable: 'Rauntímasamstilling krefst útgáfu með netkerfiseiningunum uppsettum — ekki í boði í þessari útgáfu enn.',
    ...
    removeConfirmBody: 'Það hættir að samstillast við þennan síma. Þú getur parað það aftur síðar.',
    chooseRoleTitle: 'Pörun tækja',
    chooseRoleExplain: 'Báðir símarnir þurfa að vera í sama herbergi. Ýttu á „Sýna kóðann minn“ í ÖÐRUM símanum — ýttu á „Skanna kóða“ í HINUM.',
  ...
  healthIssues: {
    ...
    emptyList: 'Ekkert hér enn — það sem þú skráir birtist á þessum lista.',
    ...
    untrackConfirmBody: 'Það hverfur af þessum lista. Allt sem þú hefur skráð verður áfram í heilsuskránni.',
    close: 'Búið',
  ...
  budget: {
    ...
    noBudgetSet: 'Settu mánaðarlega fjárhagsáætlun í stillingum til að sjá hvernig mánuðurinn stendur.',
    ...
    overPaceHint: 'Aðeins yfir daghraðanum þínum — engin hætta, bara ábending.',
  ...
  notes: {
    ...
    emptyState: 'Ekkert enn. Skrifaðu á fyrstu línuna, eða ýttu á hljóðnemann.',
    ...
    micPermissionBody: 'Það þarf aðgang að hljóðnema til að bæta við talpunkti.',
  ...
  medicine: {
    ...
    asNeededHint: 'Ekkert hólf og engin áminning — bara vörn gegn því að taka það aftur of snemma.',
    ...
    inactiveHint: 'Slökkt: það helst í sögunni en hverfur af kortinu.',
  ...
  debug: {
    ...
    toggleHint: 'Gerir þér kleift að skilja eftir athugasemdir á kortum og fyrirsögnum handa forritaranum.',
    howToUse: 'Kveikt er á honum núna — hvert kort sýnir litla „Bæta við villuleitarpunkti“-merkingu, og þú getur ýtt hvar sem er á kortinu (eða á titil skjásins) til að opna sama athugasemdareitinn. Lítil bóla merkir kort sem er þegar með athugasemd; ýttu á bóluna til að breyta eða eyða. (Hnappar gera ekki sitt venjulega verk meðan kveikt er á þessu — það er meiningin, þú ert að skrifa um þá, ekki nota þá.) Notaðu „Bæta við almennum punkti“-hnappinn neðst á skjánum fyrir það sem heyrir engu einu korti til. Í efstu valmyndinni: pöddutáknið slekkur á athugasemdahamnum aftur, græna hakið sendir alla punktana í tölvupósti, og rauði hringurinn eyðir þeim öllum.',
  ...
  designLab: {
    ...
    toggleHint: 'Vinnubekkur til að breyta útliti appsins og senda niðurstöðuna til forritarans.',
    intro: 'Breyttu því hvernig appið lítur út og sendu niðurstöðuna áfram. Ekkert hér er vistað sem stilling — þetta eru skilaboð um hvað þú vilt.',
    applyLabel: 'Nota þetta alls staðar',
    applyHint: 'Slökkt: aðeins þessi skjár breytist. Kveikt: allt appið — þar til þú slekkur aftur.',
    ...
    notePlaceholder: 'Með þínum eigin orðum — hvað leit rangt út, og hverju varstu að reyna að ná fram.',
    changeCount: (n: number) => `${n} ${isCount(n, 'breyting', 'breytingar')}`,
    modeNote: 'Ljóst og dökkt hafa hvort sína liti. Skiptu um útlit til að breyta hinu.',
    groups: {
    ...
    slotsNote: 'Á raunverulegu skjánum geta þessi aðeins falið stað. Að fylla stað er lifandi hér á bekknum, og skilaboðin sem þú sendir segja hvern.',
    idNote: 'Stuttu orðin á hnöppunum hér að neðan eru heitin sem notuð eru í skránni sem þú sendir, svo þau standa óbreytt.',
    changedTag: 'Breytt',
    ...
    selectHint: 'Ýttu á eitthvað á kortinu til að breyta því. Haltu og dragðu til að færa það, eða dragðu nýtt inn að ofan.',
    ...
    partsHint: 'Haltu og dragðu til að breyta röðinni. Ýttu á einn til að breyta honum.',
    ...
    tokensHint: 'Gildin sem öll kort eru gerð úr. Ef þú breytir einu hér breytist það alls staðar.',
    playground: {
      build: 'Byggja',
      use: 'Prófa það',
      addCard: 'Bæta við korti',
      emptyScreen: 'Ekkert á þessum skjá enn. Bættu korti við hér að neðan og settu eitthvað á það.',
      ...
      starterHints: {
        blank: 'Ekkert á því. Settu hvað sem er þar sem þú vilt.',
  ...
  feedback: {
    ...
    cardDesc: 'Fannstu villu, eða ertu með hugmynd? Skrifaðu hana hér að neðan — það opnar tölvupóstforritið þitt, stílað á forritarann.',
    placeholder: 'Hvað ertu að hugsa?',
    sendButton: 'Senda ábendingu',
    subject: 'UnFocus ábending',
    mailUnavailable: 'Fann ekkert tölvupóstforrit í þessu tæki. Reyndu aftur úr tæki þar sem tölvupóstur er uppsettur.',
  },
};
