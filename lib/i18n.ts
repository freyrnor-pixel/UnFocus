...
const en = {
  ...
  habitMoreOptionsHint: 'Icon and category — only affects how it looks in the list.',
...
const no: typeof en = {
  ...
  habitMoreOptionsHint: 'Ikon og kategori — påvirker bare hvordan den ser ut i lista.',
