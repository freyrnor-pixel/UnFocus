...
const en = {
  ...
  settings: {
    ...
    accessibility: {
      ...
      reduceEffectsHint: 'Turns off the blur, card shadows and background glow — helps on a slower phone',
      fontSize: 'Font size',
      fontSizeSmall: 'Small',
...
const no: typeof en = {
  ...
  settings: {
    ...
    accessibility: {
      ...
      reduceEffectsHint: 'Slår av uskarphet, kortskygger og bakgrunnsglød — hjelper på en tregere telefon',
...
const is: typeof en = {
  ...
  settings: {
    ...
    accessibility: {
      ...
      reduceEffectsHint: 'Slekkur á móðu, kortaskuggum og bakgrunnsljóma — hjálpar á hægari síma',
      fontSize: 'Leturstærð',
      fontSizeSmall: 'Lítil',
