...
const en = {
  ...
  weekSectionEmpty: 'No lists here — drag a collapsed list in, or make a new one below.',
...
const no: typeof en = {
  ...
  weekSectionEmpty: 'Ingen lister her ennå — dra inn en sammenslått liste, eller lag en ny under.',
