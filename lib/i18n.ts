...
const en = {
  ...
  energyMeter: {
    ...
    /** The ✏️'s accessibility label (was also the title of the retired EnergyConfigSheet). */
  ...
  firstRun: {
    ...
    motion: {
      ...
      reduced: { label: 'Less', desc: 'Transitions stay, the drifting background goes.' },
  ...
  settings: {
    ...
    accessibility: {
      ...
      reduceEffectsHint: 'Turns off card shadows, glass translucency and the background glow — helps on a slower phone',
      glassSurfaces: 'Lit card surfaces',
      glassSurfacesHint: 'Cards catch the light across their face, with a bright top edge. Turn off for flat, evenly filled cards.',
      fontSize: 'Font size',
      fontSizeSmall: 'Small',
  ...
  budget: {
    ...
    noBudgetSet: 'Set a monthly budget to compare',
    noMonthlyListForBudget: 'Add a Monthly list to set a budget',
...
const no: typeof en = {
  ...
  firstRun: {
    ...
    motion: {
      ...
      reduced: { label: 'Mindre', desc: 'Overgangene blir, den drivende bakgrunnen forsvinner.' },
  ...
  settings: {
    ...
    accessibility: {
      ...
      reduceEffectsHint: 'Slår av kortskygger, glasseffekt og bakgrunnsglød — hjelper på en tregere telefon',
      glassSurfaces: 'Opplyste kortflater',
      glassSurfacesHint: 'Kortene fanger lyset over flaten, med en lys overkant. Slå av for flate kort med jevn farge.',
  ...
  budget: {
    ...
    noBudgetSet: 'Sett et månedsbudsjett for å sammenligne',
    noMonthlyListForBudget: 'Lag en månedsliste for å sette budsjett',
...
const is: typeof en = {
  ...
  firstRun: {
    ...
    motion: {
      ...
      reduced: { label: 'Minni', desc: 'Umbreytingarnar haldast, reikandi bakgrunnurinn hverfur.' },
  ...
  settings: {
    ...
    accessibility: {
      ...
      reduceEffectsHint: 'Slekkur á kortaskuggum, glerhrifum og bakgrunnsljóma — hjálpar á hægari síma',
      glassSurfaces: 'Upplýstir kortafletir',
      glassSurfacesHint: 'Kortin fanga ljósið yfir flötinn, með bjartri efri brún. Slökktu fyrir flöt kort með jafnri fyllingu.',
      fontSize: 'Leturstærð',
      fontSizeSmall: 'Lítil',
  ...
  budget: {
    ...
    noBudgetSet: 'Settu mánaðaráætlun til að bera saman',
    noMonthlyListForBudget: 'Búðu til mánaðarlista til að setja fjárhagsáætlun',
