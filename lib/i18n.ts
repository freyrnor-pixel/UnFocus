...
const en = {
  ...
  addMoreWaysLink: 'More ways to add…',
  addMoreWaysTitle: 'Add items',
  addFromMonthlyOption: 'Add from monthly',
  addFromDishOption: 'Add dish',
...
const no: typeof en = {
  ...
  addMoreWaysLink: 'Flere måter å legge til på…',
  addMoreWaysTitle: 'Legg til varer',
  addFromMonthlyOption: 'Legg til fra månedsliste',
  addFromDishOption: 'Legg til rett',
