...
const en = {
  ...
  designLab: {
    ...
    benchTitle: 'What it looks like',
    benchHint: 'Real cards, rows and controls. They change as you turn the knobs.',
    ...
    slots: {
      ...
      'bench.a': 'Empty slot 1',
      'bench.b': 'Empty slot 2',
      'bench.c': 'Empty slot 3',
    },
    ...
    sample: {
      ...
      rowTwo: 'Another thing',
      rowThree: 'A third thing',
      meta: 'every day',
      primary: 'Main action',
...
const no: typeof en = {
  ...
  designLab: {
    ...
    benchTitle: 'Slik ser det ut',
    benchHint: 'Ekte kort, rader og kontroller. De endrer seg mens du skrur.',
    ...
    groups: {
      color: 'Farge',
      shape: 'Form og avstand',
      controls: 'Typer kontroller',
