...
const en = {
  ...
  tasksFinishedZone: (n: number) => `Finished (${n})`,
  tasksDoneLabel: 'Done',
  ...
  settings: {
    accessibility: {
      ...
      glassBlur: 'Frosted blur',
      glassBlurHint: 'Blurs the background behind cards (Android; needs Android 12+). Turn off if scrolling stutters or buttons feel unresponsive',
      fontSize: 'Font size',
      fontSizeSmall: 'Small',
  ...
  debug: {
    ...
    howToUse: 'When on: long-press any card or header to add a note — a small bubble marks it, tap the bubble to edit or clear it. Use the export icon in the top header to send your notes, or Reset below to clear them all.',
    editNote: 'Edit note',
...
const no: typeof en = {
  ...
  tasksFinishedZone: (n: number) => `Ferdig (${n})`,
  ...
  settings: {
    accessibility: {
      ...
      glassBlur: 'Frostet uskarphet',
      glassBlurHint: 'Gjør bakgrunnen bak kort uskarp (Android; krever Android 12+). Slå av hvis rulling hakker eller knapper føles trege',
  ...
  debug: {
    ...
    howToUse: 'Når på: hold inne et kort eller en topptekst for å legge til en notis — en liten boble markerer den, trykk på boblen for å redigere eller slette. Bruk eksporter-ikonet i toppmenyen for å sende notatene dine, eller Nullstill under for å slette alle.',
