...
card, all five tabs, Settings, (2026-08-01) the **task editor**, which it reaches by
creating a task and tapping it — a fresh profile has none — and (2026-08-03) the **Energy config
sheet**, opened from the strip's tutorial-state button on Home and closed again before the tab
loop (a bottom sheet's scrim swallows every click under it). Until then the audit had never
