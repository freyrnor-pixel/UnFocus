 ...
 *
 * So the tabs are authored as ONE continuous 1950×844 strip (5 × 390) and the app slides
 * it with the pager, exactly as onboarding slides the triptych. (It was 1170×844 / 3 × 390
 * between the 2026-08-20 5→3 tab merge and the 2026-08-22 restore — the strip's width is
 * derived from PANELS.length, so re-running this script is the whole migration, in either
 * direction.) Continuity is then structural
 ...
 * **Five panels again since 2026-08-22** — it was five until the 2026-08-20 5→3 tab merge, and
 * the tabs are back in the same order, so both this list and `SPINE_Y` below are the pre-merge
 * values verbatim rather than newly cut ones.
 */
