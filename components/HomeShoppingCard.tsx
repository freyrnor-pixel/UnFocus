...
const baseStyles = StyleSheet.create({
  ...
  // `card`/`cardCollapsed`/`cardContent` went with the Surface: Card owns the geometry, the
  // horizontal inset and the closed-state bottom inset now.
  ...
  // ⚠️ The card's own header styles are DELETED (2026-08-22). components/Card.tsx draws the
  // badge, the title, the count and the fold from lib/cardRegistry.ts's `homeShopping` entry —
  // this file drew all four by hand, which is exactly the divergence the registry ended.
  ...
  // share styles with became the shared explainer line (2026-07-30 at the foot, back under the header
